...
void via_init_kb(void) {
    kb_config_t stored_config = {0};
    eeconfig_read_kb_datablock(&stored_config, 0, EECONFIG_KB_DATA_SIZE);

    if (stored_config.default_brightness_flag != KB_CONFIG_MAGIC || stored_config.config_version != KB_CONFIG_VERSION) {
        eeconfig_init_via();
    }
}
#endif
