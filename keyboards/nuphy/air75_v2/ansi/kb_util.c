...
void londing_eeprom_data(void) {
    ...
    if (kb_config.default_brightness_flag != KB_CONFIG_MAGIC || kb_config.config_version != KB_CONFIG_VERSION) {
        ...
        kb_config.default_brightness_flag = KB_CONFIG_MAGIC;
        ...
        kb_config.config_version          = KB_CONFIG_VERSION;
