...
#define KB_CONFIG_MAGIC 0xA5
#define KB_CONFIG_VERSION 0x75
...
STATIC_ASSERT(sizeof(kb_config_t) == EECONFIG_KB_DATA_SIZE, "kb_config_t must match its EEPROM allocation");
